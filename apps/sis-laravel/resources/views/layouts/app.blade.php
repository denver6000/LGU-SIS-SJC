        ...
        <aside class="workspace-rail" data-rail>
            ...
            <nav class="rail-nav" aria-label="Main navigation">
                ...
                @if(auth()->user()->isAdmin())
                    ...
                    <a class="{{ request()->routeIs('payrolls.recovery') ? 'active' : '' }}" href="{{ route('payrolls.recovery') }}"><span>↶</span> Payroll recovery</a>
                @endif
                ...
                @if(auth()->user()->isAdmin())
                    ...
                    <a class="{{ request()->routeIs('records.cycle-correction') ? 'active' : '' }}" href="{{ route('records.cycle-correction') }}"><span>⇄</span> Cycle correction</a>
                @endif
            </nav>
